...
function Input(props: Props) {
  return (
    <div>
      <input
        className={`w-90 p-[16px] mb-2 font-semibold rounded-5 text-black leading-[26px] text-base font-['inherit'] border-2 border-solid focus:outline-none focus:ring-bgColor focus:border-bgColor ${
      ...
      {props.isInput && props.id === "email" && props.value === "" && (
