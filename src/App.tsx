  ...
  return (
    <div className=" h-screen bg-bgColor ">
        <div className="flex md:flex-row flex-col justify-center items-center text-center">
          ...
          <div className="md:m-32 flex flex-col justify-center items-center w-1/2 ">
            <Trial text="Try it free 7 days then $20/mo. thereafter" />
            <div className="flex flex-col justify-center items-center bg-white shadow-3xl pt-[1.2em] pr-[0.5em] pb-[1em] pl-[0.5em] rounded-lg w-90 shadow-md">
              <Input 
              type="text"
              id="name"
